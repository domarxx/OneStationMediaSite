      ...
      <div className="container px-6">
        <div className="flex items-center justify-between gap-4 mb-8">
          <div>
            ...
            <p className="mt-2 text-muted-foreground max-w-2xl text-sm md:text-base">
              Conheça alguns cases recentes em que combinamos dados, criatividade
              e inventário premium para gerar impacto real para as marcas.
            </p>
          </div>
        ...
        <div className="grid gap-6 md:grid-cols-3">
          {latestStudies.map((study) => (
            <article
              key={study.id}
              className="group rounded-xl border border-border/60 bg-background/60 overflow-hidden hover:border-primary/60 hover:bg-background/90 transition-colors"
            >
              {/* Thumbnail */}
