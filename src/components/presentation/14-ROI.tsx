        ...
        <div className="grid lg:grid-cols-2 gap-6 md:gap-12 items-center">
          ...
          <div className="relative flex justify-center animate-slide-right order-1">
            ...
            <img 
              ...
              className="relative z-10 w-full max-w-[300px] md:max-w-[400px] lg:max-w-[500px] h-auto object-contain drop-shadow-[0_0_50px_rgba(var(--primary),0.5)] animate-float"
              style={{ animationDuration: '3s' }}
            />
          </div>

          {/* LADO DIREITO: Texto de Impacto */}
          {/* 1. items-center: Centraliza o BLOCO na tela no mobile. md:items-start: Alinha à esquerda no desktop */}
          <div className="flex flex-col items-center md:items-start animate-slide-left order-2">
            
            {/* 2. Wrapper w-fit: Faz o container abraçar o conteúdo (para ser centralizado), mas permite alinhamento interno */}
            <div className="flex flex-col w-fit md:w-full">
              
              {/* Texto alinhado à esquerda DENTRO do bloco centralizado */}
              ...
              <div className="flex flex-col gap-4 md:gap-6 w-full">
                {highlights.map((item, index) => (
                  <div 
                    key={index}
                    // 3. justify-start: Ícone e texto começam na esquerda do bloco
