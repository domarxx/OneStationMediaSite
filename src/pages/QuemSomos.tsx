...
const QuemSomos = () => {
  ...
  // --- ANIMAÇÕES GSAP ---
  const heroTextRef = useFadeIn({ delay: 0.2 });
  const aboutTextRef = useFadeIn({ delay: 0.1, threshold: 0.1 });
  // Opcional: animar os stats separadamente ou junto com o bloco de texto? 
  // Vou deixar junto por enquanto, já está dentro do bloco
    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="pt-24 pb-16 md:pb-24">
        ...
        <section id="QuemSomos" className="relative min-h-[50vh] flex items-center overflow-hidden mb-12 md:mb-16">
          ...
          <div className="container relative z-10 px-6">
            <div className="flex flex-col items-center text-center w-full">
              {/* Adicionado ref e invisible */}
              <div className="max-w-4xl mx-auto invisible" ref={heroTextRef}>
        ...
        <section className="container px-6 mb-24">
          {/* Removido 'animate-slide-up', adicionado ref e 'invisible' */}
          <div ref={aboutTextRef} className="max-w-3xl mx-auto text-center space-y-8 invisible">
